...
export default (props) => {
  render () {
    const { id, address, first_name, last_name, due_date, title, overdue } = props 
    ...
    return (
      <div className='main-container letter-page'>
        ...
        <div className='letter'>
          ...
          <p>We notice that your Standing Order which is normally paid on {due_date} each year has not been paid this year and  £{balance}  has now been unpaid for over { calculateOverdue(overdue) } days.  We assume that this is probably an administrative error and would be very grateful if you could look into it.</p>
