...
`Friends of Chichester Harbour
Dear ${greeting},
We would be very grateful for payment of the amount of ${formatPounds(overdue / 100)} which has now been outstanding for over ${n} days.  Payment can be made by logging in online to friendsch.org where you can pay by Credit Card, Debit Card or PayPal. Or you can pay by direct bank transfer to Friends of Chichester Harbour, Account No: 87037440,  Sort Code 52-41-20 quoting your membership number ${id}. Or you can send a cheque, quoting your membership number ${id} to Pam Marrs, Membership Secretary FOCH, 42 Bracklesham Road, Hayling Island PO11 9SJ.  If you have already paid, our apologies and please ignore this email.
...
`Friends of Chichester Harbour
Dear ${greeting},
Your annual  subscription of ${formatPounds(amount / 100)} becomes due on ${format(due_date)} and we do hope that you will renew your membership of the Friends of Chichester Harbour.  To renew your membership log in online to friendsch.org where you can pay by Credit Card, Debit Card or PayPal. Or you can pay by direct bank transfer to Friends of Chichester Harbour, Account No: 87037440, Sort Code 52-41-20 quoting your membership number ${id}. Or you can send a cheque, quoting your membership number ${id} to Pam Marrs, Membership Secretary FOCH, 42 Bracklesham Road, Hayling Island PO11 9SJ.  If you have already paid, our apologies and please ignore this email.
Richard Evans, Treasurer FoCH`
