...
`Newsletter from Friends of Chichester Harbour
Dear ${greeting},
...
`Newsletter Reminder from Friends of Chichester Harbour
Dear ${greeting},
...
`Overdue Subscriptions for Friends of Chichester Harbour
Dear ${greeting},
...
`Overdue Standing Order from Friends of Chichester Harbour
Dear Richard,
