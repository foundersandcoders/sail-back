...
module.exports.replaceNice = function replaceNice (string) {
 ...
 */
module.exports.lastSub = function (payments) {
...
module.exports.orderPayments = function (payments) {
...
module.exports.balanceDue = function (payments) {

  var ordered = module.exports.orderPayments(payments)
